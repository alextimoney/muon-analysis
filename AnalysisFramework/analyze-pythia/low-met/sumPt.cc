...

{
  ...
  TH1F *sum1 = new TH1F("sum1", "sum1", 60, 0, 120);
  TH1F *sum2 = new TH1F("sum2", "sum2", 60, 0, 120);
  TH1F *sum3 = new TH1F("sum3", "sum3", 60, 0, 120);
  TH1F *sum4 = new TH1F("sum4", "sum4", 60, 0, 120);
  TH1F *sum5 = new TH1F("sum5", "sum5", 60, 0, 120);
  TH1F *sum6 = new TH1F("sum6", "sum6", 60, 0, 120);
  TH1F *sum7 = new TH1F("sum7", "sum7", 60, 0, 120);
  TH1F *sum8 = new TH1F("sum8", "sum8", 60, 0, 120);


  for (int i = 0; i < 28; i++) {
    TH1F *tempall = (TH1F*)infile[i].Get("Bare_Muon_pT");
    TH1F *temp1 = (TH1F*)infile[i].Get("MetJetPt1");
    TH1F *temp2 = (TH1F*)infile[i].Get("MetJetPt2");
    TH1F *temp3 = (TH1F*)infile[i].Get("MetJetPt3");
    TH1F *temp4 = (TH1F*)infile[i].Get("MetJetPt4");
    TH1F *temp5 = (TH1F*)infile[i].Get("MetJetPt5");
    // TH1F *temp6 = (TH1F*)infile[i].Get("MetJetPt6");
    // TH1F *temp7 = (TH1F*)infile[i].Get("MetJetPt7");
    // TH1F *temp8 = (TH1F*)infile[i].Get("MetJetPt8");
  ...
  leg->AddEntry(sum1, "0 < Sum pT [GeV] < 20","f");
  leg->AddEntry(sum2, "20 < Sum pT [GeV] < 22", "f");
  leg->AddEntry(sum3, "22 < Sum pT [GeV] < 25", "f");
  leg->AddEntry(sum4, "25 < Sum pT [GeV] < 28", "f");
  leg->AddEntry(sum5, "28 < Sum pT [GeV] < 30", "f");
