...
class MyAnalysis {
 ...
 public:
  ...
  void analyze(Event& event, Event& partonevent, std::vector<double> EventWeights);
 ...
 private:
  ...
  std::vector<float> MuIso_Coll;
  std::vector<float>* p_MuIso_Coll;

  std::vector<float> MuIso_Coll_Eta;
  std::vector<float>* eta_MuIso_Coll;
  ...
  int nTop, nNeutrino, nMuonBare, nElectronBare, nMuonDress, nElectronDress, nMuonBorn, nElectronBorn, nLightjetBare, nBjetBare, nJetDress, nJetBorn, nLargeRjetDress, nLargeRjetBare, nLargeRjetBorn, nBoson, nLightpartonjet, nBpartonjet;
  ...
  std::vector<float> muonisolation_pt, muonisolation_eta, muonisolation_phi, muonisolation_E;
