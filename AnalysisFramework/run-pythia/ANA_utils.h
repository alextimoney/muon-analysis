...
class ANA_utils {
 ...
 public :
  ...
  void Get_StableMuons(Pythia8::Event event, std::vector<TruthPart>* p_PromptBareLept_Coll, std::vector<float>* p_MuIso_Coll, std::vector<float>* eta_MuIso_Coll);

  void Get_BarePromptLepton(Pythia8::Event event, std::vector<int> vecboson_index, std::vector<TruthPart>* p_PromptBareLept_Coll, std::vector<TruthPart>* p_ConversionLept_Coll, std::vector<TruthPart>* p_PhotonFSR_Coll, std::vector<TruthPart>* p_Neutrino_Coll, std::vector<float>* p_MuIso_Coll, std::vector<float>* eta_MuIso_Coll);

  void Get_DressPromptLepton(std::vector<TruthPart> BareLept_Coll, std::vector<TruthPart> PhotonFSR_Coll, std::vector<TruthPart>* p_DressLept_Coll, std::vector<TruthPart>* p_PhotonDress_Coll);
  ...
  // void Get_MuonIsolation(Pythia8::Event event, std::vector<TruthPart>* p_MuIso_Coll);
  void Get_MuonIsolation(Pythia8::Event event, std::vector<float>* p_MuIso_Coll, std::vector<float>* eta_MuIso_Coll);
